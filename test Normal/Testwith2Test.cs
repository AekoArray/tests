...
public class Testwith2Test {
  ...
  public void testwith2() {
    ...
    driver.FindElement(By.CssSelector(".title-field .editor")).Click();
    {
      ...
      js.ExecuteScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<span>NewTestTitle</span>'}", element);
    }
    driver.FindElement(By.CssSelector(".editor-richtext")).Click();
    {
      var element = driver.FindElement(By.CssSelector(".editor-richtext"));
      js.ExecuteScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>do new test<br></p>'}", element);
    }
    ...
    {
      var element = driver.FindElement(By.CssSelector(".editor-richtext"));
      js.ExecuteScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>there is the test<br></p>'}", element);
    }
    driver.FindElement(By.CssSelector(".button-area")).Click();
  }
}
